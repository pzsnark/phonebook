...
class CreateADUserForm(forms.Form):
    ...
    ext_name = forms.CharField(label='Отчество', max_length=100)
    ...
    ip_phone = forms.CharField(label='Внутренний телефон', max_length=100, required=None)
    phone = forms.CharField(label='Сотовый телефон', max_length=12, required=None)
