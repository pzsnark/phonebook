...
class Entry(models.Model):
    ...
    displayName = models.CharField('Отображаемое имя', max_length=255, null=True, blank=True)
    ...
    company = models.ForeignKey(Company, related_name='company', null=True, on_delete=models.CASCADE)
